...
# Target: /Users/bruce/CLAUDE/asap5/stdcells/fused_ppa/FUSED_A.mag
...
# Gate assignments (24 gates, 0-23):
#   0: INV ai     1: INV bi     2: INV aj     3: INV bj
#   4-5: XOR0 stack A (ai/bi paths)
#   6-7: XOR0 stack B (nai/nbi paths)
#   8-9: XOR1 stack A (aj/bj paths)
#  10-11: XOR1 stack B (naj/nbj paths)
#  12: INV d0->xn0   13: INV d1->xn1
#  14-15: OH0 NOR2(d0,d1)
#  16-17: OH1 AOI22 stack A (d0/xn1)
#  18-19: OH1 AOI22 stack B (xn0/d1)
#  20: OH1 output INV
#  21-22: OH2 NAND2(d0,d1)
#  23: OH2 output INV
