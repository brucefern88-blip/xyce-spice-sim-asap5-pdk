# Build FUSED_G layout — Variant G (Active-Low, 40T, 20 gate pitches)
...
set noh1_a_l [expr {[gx 14] - 12}]
drain_m1 $noh1_a_l [expr {[gx 14] - 2}]
set noh1_b_l [expr {[gx 16] - 12}]
drain_m1 $noh1_b_l [expr {[gx 16] - 2}]

set noh2_l [expr {[gx 18] - 12}]
drain_m1 $noh2_l [expr {[gx 18] - 2}]
...
box $d0v 72 [expr {$g18v + 6}] 78
paint metal2
box $d0v 72 [expr {$d0v + 6}] 78
paint via1
box $g14v 72 [expr {$g14v + 6}] 78
paint via1
...
set noh1av [expr {$noh1_a_l + 2}]
set noh1bv [expr {$noh1_b_l + 2}]
box $noh1av 32 [expr {$noh1bv + 6}] 38
paint metal2
box $noh1av 32 [expr {$noh1av + 6}] 38
paint via1
box $noh1bv 32 [expr {$noh1bv + 6}] 38
paint via1
...
label bj 1 cogc
box [expr {$noh1_a_l + 4}] 70 [expr {$noh1_a_l + 4}] 70
label noh1 1 metal1
box [expr {$noh2_l + 4}] 70 [expr {$noh2_l + 4}] 70
label noh2 1 metal1
...
save /Users/bruce/CLAUDE/asap5/stdcells/layouts/fused/FUSED_G
...
extract all
ext2spice lvs
ext2spice -f ngspice -o /Users/bruce/CLAUDE/asap5/stdcells/layouts/fused/FUSED_G_ext.spice

puts "FUSED_G layout complete: ${W}nm x ${H}nm, $NG gate pitches, 40T"
